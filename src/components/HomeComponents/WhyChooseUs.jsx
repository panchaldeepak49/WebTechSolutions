...
const WhyChooseUs = () => {
  ...
  return (
    <>
      <p className='mt-10 flex justify-center text-4xl font-Rubik '>Why choose us ?</p>
     ...
     <div className='mt-10 px-10 grid grid-cols-1 sm:grid-cols-2 gap-2 '>
       <div className=' w-[100%] flex justify-center sm:justify-end items-center text-lg '>  {/* bg-red-400 */}
         <p className='w-[70%] text-base bg-blue-200 rounded-md p-4 font-thin'>
       ...
       <img src={Img2} className='w-[50%]  sm:h-auto rounded-md'  />
       </div>
     </div>
    </>
  )
